...
[以下](http://www.tutorialspoint.com/ajax/what_is_ajax.htm)是我认为对`AJax`较为准确的解释：
...
关于[XMLHttpRequest的浏览器兼容性](http://caniuse.com/#search=XMLHttpRequest)，大家可以直接查看“Can I use”这个网站提供的结果：
